...
targetFile="cangulo.nuke.prcommitsvalidations-linux-x64.zip"
outputFolder="./cangulo.nuke.prcommitsvalidations"

echo "::group::downloading $targetFile"

if [[ $version == "latest" ]]; then
    echo "downloading latest version"
    url="https://github.com/cangulo/cangulo.nuke.prcommitsvalidations/releases/$version/download/$targetFile"
else
    echo "downloading version $version"
    url="https://github.com/cangulo/cangulo.nuke.prcommitsvalidations/releases/download/$version/$targetFile"
fi
